...
const About = (props) => {
  ...
  return (
    <div id="wrap" className="about">
      <div id="sec01" className="about_kv section01 section">
      ...
      <div id="sec02" className="section02 section">
        <div className="cont_wrap">
          <div className="cont_box cont_text">
            <div className="texts text_1">
              <p className="sec_tit change_color">강점 및 특징</p>
              <p className="change_color">
                <span className='aw_text_tit'>1. 뛰어난 문제 해결 능력 :</span><br />
                <span className='aw_text_txt'>어려운 상황에서도 논리적이고 창의적인 해결책을 찾는 능력이 있습니다.</span><br />
              </p>
              <p className="change_color">
                <span className='aw_text_tit'>2. 팀 협업 능력 :</span><br />
                <span className='aw_text_txt'>다양한 역할과 배경을 가진 팀원들과 원활한 소통과 협업이 가능합니다.</span><br />
              </p>
              <p className="change_color">
                <span className='aw_text_tit'>3. 지속적인 학습 :</span><br />
                <span className='aw_text_txt'>
                  빠르게 변화하는 기술 트렌드에 대한 관심과 학습 의지가 강합니다. 어려운 상황에서도 논리적이고 창의적인 해결책을 찾는 능력이 있습니다.
                </span><br />
              </p>
            </div>
          </div>
          <div className="cont_box">
            <div className="sec_tit poppins">AWARDS</div>
            <p>
